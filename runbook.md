...
Confirm:
- State is **Running**
- No checkpoints unexpectedly exist
- No critical events in Hyper‑V Manager
...
## 3.2 Execute Backup
```powershell
.\VampireGuard-Backup.ps1 -Verbose
```
...
- Backup directory receives new timestamped folder
- VM restarts
